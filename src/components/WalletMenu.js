        ...
        <div className='wallet-container' ref={modalRef} onClick={closeModal}>
            ...
            <div className='wallet-modal'>
                ...
                <h2>Your Wallet</h2>
                    ...
                    <a href='https://pancakeswap.finance/swap#/swap?outputCurrency=0xE81FE8bBBEA13A0fd5Cc0AAFb6062631C659eC54' target='_blank'><button className='deposit btn' onClick="window.open('https://pancakeswap.finance/swap#/swap?outputCurrency=0xE81FE8bBBEA13A0fd5Cc0AAFb6062631C659eC54')">Buy $RETRO</button></a>
                </div>
